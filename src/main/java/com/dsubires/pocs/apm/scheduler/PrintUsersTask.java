package com.dsubires.pocs.apm.scheduler;

import co.elastic.apm.api.CaptureSpan;
import co.elastic.apm.api.CaptureTransaction;
import com.dsubires.pocs.apm.repository.UserRepository;
...
public class PrintUsersTask {
    ...
    private void doExecute() {
        userRepository.findAll().forEach(user -> log.info(user.getEmail()));
        sleep();
    }
